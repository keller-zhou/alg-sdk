package com.slicejobs.algsdk.algtasklibrary.ui.widget.refresh;
...
final class SwipeProgressBar {
    ...
    public SwipeProgressBar(View parent) {//颜色默认值初始化
        mParent = parent;
        mColor1 = SliceApp.CONTEXT.getResources().getColor(R.color.text_color3);
        mColor2 = SliceApp.CONTEXT.getResources().getColor(R.color.color_base);
        mColor3 = SliceApp.CONTEXT.getResources().getColor(R.color.text_color3);
        mColor4 = SliceApp.CONTEXT.getResources().getColor(R.color.color_base);
    }
