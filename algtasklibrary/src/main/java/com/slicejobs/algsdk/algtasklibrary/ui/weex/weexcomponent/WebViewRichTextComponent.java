...
public class WebViewRichTextComponent extends WXComponent<MyRichTextView> {
    ...
    public WebViewRichTextComponent(WXSDKInstance instance, WXVContainer parent, BasicComponentData basicComponentData) {
    ...
    private class WebViewResizer {
        ...
        public void processHeight(String height) {
            ...
            params.put("richHeight", h);
            //发送全局监听
            mInstance.refreshInstance(params);
        }
    }
}
