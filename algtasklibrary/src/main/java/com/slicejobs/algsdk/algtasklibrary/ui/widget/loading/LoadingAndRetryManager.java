...
public class LoadingAndRetryManager
{
    ...
    public static int BASE_RETRY_LAYOUT_ID = R.layout.view_net_error;
    public static int BASE_EMPTY_LAYOUT_ID = NO_LAYOUT_ID;

    public LoadingAndRetryLayout mLoadingAndRetryLayout;
    private OnLoadingAndRetryListener onLoadingAndRetryListener;
    ...
    public LoadingAndRetryManager(Object activityOrFragmentOrView, OnLoadingAndRetryListener listener)
    {
        ...
        //setupLoadingLayout(isActivity,listener, loadingAndRetryLayout);
        //setupRetryLayout(isActivity,listener, loadingAndRetryLayout);
        //callback
    ...
    private void setupLoadingLayout(boolean isActivity,OnLoadingAndRetryListener listener, LoadingAndRetryLayout loadingAndRetryLayout)
    {
        if (listener.isSetLoadingLayout())
        {
            ...
            if (layoutId != NO_LAYOUT_ID)
            {
                loadingAndRetryLayout.setLoadingView(isActivity,layoutId);
            } else
            {
        ...
        } else
        {
            if (BASE_LOADING_LAYOUT_ID != NO_LAYOUT_ID)
                loadingAndRetryLayout.setLoadingView(isActivity,BASE_LOADING_LAYOUT_ID);
        }
    }

    private void setupRetryLayout(boolean isActivity,OnLoadingAndRetryListener listener, LoadingAndRetryLayout loadingAndRetryLayout)
    {
        if (listener.isSetRetryLayout())
        {
            ...
            if (layoutId != NO_LAYOUT_ID)
            {
                loadingAndRetryLayout.setRetryView(isActivity,layoutId);
            } else
            {
        ...
        } else
        {
            if (BASE_RETRY_LAYOUT_ID != NO_LAYOUT_ID)
                loadingAndRetryLayout.setRetryView(isActivity,BASE_RETRY_LAYOUT_ID);
        }
    }
    ...
    {
        mLoadingAndRetryLayout.setLoadingView(isActivity,BASE_LOADING_LAYOUT_ID);
        mLoadingAndRetryLayout.showLoading();
    }

    public void showRetry()
    {
        mLoadingAndRetryLayout.setRetryView(isActivity,BASE_RETRY_LAYOUT_ID);
        onLoadingAndRetryListener.setRetryEvent(mLoadingAndRetryLayout.getRetryView());
