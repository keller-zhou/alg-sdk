...
public class CameraView extends CameraViewLayout {
    ...
    private String photoQuality;//"1"低 "2"中 "3"高
    ...
    public CameraView(@NonNull Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
        ...
        this.mFocus = 1;
        this.mMethod = 0;
        this.mPinchToZoom = true;
        this.mZoom = 1.0F;
        this.mPermissions = 0;
        this.mVideoQuality = 0;
        this.mJpegQuality = 100;
        this.mCropOutput = false;
        this.mVideoBitRate = 0;
        this.mDoubleTapToToggleFacing = false;
        this.mLockVideoAspectRatio = false;
    ...
    public void setPhotoQuality(String photoQuality) {
        ...
        this.mCameraImpl.setPhotoQuality(this.photoQuality);
    }
